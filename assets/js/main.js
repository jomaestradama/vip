...
$(document).ready(function () {
    ...
    var swiperBlog = new Swiper('.swiper-blog-3', {
        pagination: '.swiper-pagination-two-slides',
        slidesPerView: 2,
    ...
    var swiperBlog = new Swiper('.swiper-blog-2', {
    ...
    if ($('#instaFeed-footer').length != 0) {
        var instaFeedFooter = new Instafeed({
            ...
            userId: 233736077,
            limit: '3',
            accessToken: '233736077.35833a4.f6aab48f61054507905762dc682e6f39',
            resolution: "low_resolution",
            after: function () {
                equalizeHeight();
            },
...
$(document).ready(function() {
    $.each( $('[data-style]'), function(key, value) {var style = $(this).data("style"); if($(this).hasAttr("style")) {style += " " + $(this).attr("style"); } $(this).attr("style", style); } );
});